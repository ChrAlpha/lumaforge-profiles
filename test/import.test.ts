  ...
  test("applies reviewed source package rules for the remaining supported vendors", async () => {
    ...
    const fixtures = [
      ...
      },
      {
        ...
        expectedTitle: "High Contrast / R3 Soft",
        expectedLutTitle:
          "RED IPP2 LUT to map REDWideGamutRGB/Log3G10 to REC709/BT1886/HIGH_CONTRAST/Rolloff 3 - soft",
        expected: {
      ...
      },
      {
        ...
        expectedTitle: "Classic Rec.2020",
        expectedLutTitle: "Software Leica Camera LUT Film V6.3 Rec2020 Gamma 2.4",
        expected: {
      ...
      },
      {
        namespace: "dji",
        relativePath:
          "imports/dji/mavic-4-pro-d-log-to-rec709/DJI Mavic 4 Pro D-Log to Rec.709 V1.cube",
        content: "LUT_3D_SIZE 33\n",
        expected: {
          ...
          intent: "technical-output",
          contractSourceId: "dji-mavic-4-pro-d-log-to-rec709"
        }
      },
      {
        namespace: "dji",
        relativePath:
          "imports/dji/mavic-4-pro-d-log-m-to-rec709/DJI Mavic 4 Pro D-Log M to Rec.709 V1.cube",
        content: "LUT_3D_SIZE 33\n",
        expected: {
          ...
          family: "dji-mavic-4-pro",
          intent: "technical-output",
          contractSourceId: "dji-mavic-4-pro-d-log-m-to-rec709"
        }
      },
      {
        namespace: "insta360",
        relativePath:
          "imports/insta360/insta360-lut-24608b22/Insta360-LUT 10/Insta360 Ace Pro 2 LUT/AcePro2_I-Log_To_Rec.709_V1.0.cube",
        content: 'TITLE "Generated by Resolve"\nLUT_3D_SIZE 33\n',
        expected: {
          ...
          variant: "ace-pro-2",
          intent: "technical-output",
          contractSourceId: "insta360-lut-10-i-log-to-rec709"
        }
      },
      {
        namespace: "om-system",
        relativePath:
          "imports/om-system/om3_lut_flat_bt.709_to_sdr_bt.709_v1.0/om3_LUT_Flat_BT.709_to_SDR_BT.709_v1.0/OMSYSTEM_Flat_BT.709_to_SDR_BT.709_v1.0.cube",
        content: "LUT_3D_SIZE 33\n",
        expected: {
          ...
          intent: "technical-output",
          contractSourceId: "om-system-flat-bt709-to-sdr-bt709"
        }
      },
      {
        namespace: "om-system",
        relativePath:
          "imports/om-system/om3_lut_om-log400_bt.2020_to_wdr_bt.709_v1.0/om3_LUT_OM-Log400_BT.2020_to_WDR_BT.709_v1.0/OMSYSTEM_OM-Log400_BT.2020_to_WDR_BT.709_v1.0.cube",
        content: "LUT_3D_SIZE 33\n",
        expected: {
          ...
          family: "om-system-3d-lut",
          intent: "technical-output",
          contractSourceId: "om-system-om-log400-bt2020-to-wdr-bt709"
        }
      },
      {
        namespace: "om-system",
        relativePath:
          "imports/om-system/om3_lut_om-log400_p3-d65_to_wdr_bt.709_v1.0/om3_LUT_OM-Log400_P3-D65_to_WDR_BT.709_v1.0/OMSYSTEM_OM-Log400_P3-D65_to_WDR_BT.709_v1.0.cube",
        content: "LUT_3D_SIZE 33\n",
        expected: {
          inputTransfer: "om-system-om-log400",
          ...
          family: "om-system-3d-lut",
          intent: "technical-output",
          contractSourceId: "om-system-om-log400-p3-d65-to-wdr-bt709"
        }
      },
      {
        namespace: "panasonic",
        relativePath:
          "imports/panasonic/v-log-v-gamut-to-rec709-from-lumix-lab/Vintage Blues.cube",
        content: 'TITLE "Generated by Resolve"\nLUT_3D_SIZE 33\n',
        expectedTitle: "Vintage Blues",
        expectedLutTitle: "Vintage Blues",
        expected: {
          inputTransfer: "v-log",
          inputGamut: "v-gamut",
          outputTransfer: "srgb",
          ...
          variant: "vintage-blues",
          intent: "display-look",
          contractSourceId: "panasonic-v-log-v-gamut-to-rec709-from-lumix-lab"
        }
      }
    ] as const;
    ...
    for (const fixture of fixtures) {
      ...
      const entry = result.written.find((item) => item.sourcePath.endsWith(fixture.relativePath));
      expect(entry).toBeDefined();
      const manifest = await readJson<any>(root, `${entry!.entryDir}/manifest.json`);
      if ("expectedTitle" in fixture) {
        expect(manifest.title).toBe(fixture.expectedTitle);
      }
      if ("expectedLutTitle" in fixture) {
        expect(manifest.lut.title).toBe(fixture.expectedLutTitle);
      }
      expect(manifest.lut).toMatchObject({
        ...fixture.expected,
        contractSource: "source-package-rule",
